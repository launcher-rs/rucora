...
//! # 概述
//!
//! 本模块定义了 Agentkit 统一的事件模型，用于在组件之间传递消息。
...
///
/// ```rust
/// use agentkit_core::channel::types::TokenDeltaEvent;
///
...
///
/// ```rust
/// use agentkit_core::channel::types::SkillEvent;
/// use serde_json::json;
///
/// // Skill 开始执行
...
///
/// ```rust
/// use agentkit_core::channel::types::MemoryEvent;
/// use serde_json::json;
///
/// // 记忆写入
/// let add = MemoryEvent {
...
///
/// ```rust
/// use agentkit_core::channel::types::DebugEvent;
/// use serde_json::json;
///
...
///
/// ```rust
/// use agentkit_core::channel::types::ErrorEvent;
/// use serde_json::json;
///
/// // Tool 错误
...
/// Channel 层传递的事件类型
///
/// 这是 Agentkit 的统一事件模型，用于在组件之间传递消息。
/// 所有事件都支持序列化，便于 Trace 记录和回放。
///
/// # 变体说明
///
