...
//! use rucora_mcp::transport::StdioTransport;
//!
...
//! let result = adapter.call(serde_json::json!({}), &ctx).await?;
//! # Ok(())
//! # }
//! ```
//!
...
/// MCP 工具适配（将远端 MCP 工具包装为 `rucora-core` 的 Tool）
pub use tool::*;
