...
use rucora::agent::{SimpleAgent, ToolAgent};
use rucora::prelude::Agent;
use rucora::provider::OpenAiProvider;
use rucora::tools::{EchoTool, ShellTool};
use std::sync::Arc;
...
async fn main() -> anyhow::Result<()> {
    ...
    info!("╔════════════════════════════════════════╗");
    info!("║   rucora Supervisor Agent 示例      ║");
    info!("╚════════════════════════════════════════╝\n");
    ...
    match tool_expert.run(tool_task.into()).await {
        Ok(output) => {
            let output: rucora_core::agent::AgentOutput = output;
